...
router.post("/complaints", multer({ storage: diskStorage }).single("support_image"), complaintController.storeComplaint);
router.put("/complaints/:id", multer({ storage: diskStorage }).single("support_image"), complaintController.updateComplaint);
